...
export default function ProjectCard({
  ...
  return (
    <motion.div whileHover={{ scale: 1.03 }} transition={{ duration: 0.3 }} className="flex flex-col lg:flex-row items-center justify-between gap-10">
      <div className="bg-[#1a1a1a] rounded-lg w-full md:h-full lg:h-[70vh]"><img src={src} alt={alt} className="mx-auto block w-full h-full object-cover rounded-lg p-10" /></div>
